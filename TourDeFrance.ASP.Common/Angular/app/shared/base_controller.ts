...
abstract class BaseController {
    ...
    constructor(protected Restangular: restangular.IService, protected GlobalService: TourDeFrance.Service.IGlobalService, protected $state: ng.ui.IStateService,
        protected $mdToast: ng.material.IToastService, currentUser: AuthenticatedUser) {
